!function (global) {
    ...
    ym.modules.define("cnst.current-script", ["config"], function (e, t) {
        ...
        e({
            ...
            "originalUrl": "https://api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%3A6d6c5e421e299aa67166dccef5f9f43c00ffa67fe482f99d400b37fd645b62a0&amp;width=100%25&amp;height=100%&amp;lang=ru_RU&amp;scroll=true",
        ...
        e({
            ...
            "maps": [{
                "properties": {
                    "sid": "constructor:6d6c5e421e299aa67166dccef5f9f43c00ffa67fe482f99d400b37fd645b62a0",
                    "created": 1524906080,
                    "updated": 1524906229,
                    "authorUid": "1130000022628741",
                    "access": "public",
                    "revision": "13",
                    "name": "medstyle moscow",
                    "description": ""
                },
                "state": {
                    "size": [500, 400],
                    "center": [37.60809093366628, 55.80850819293995],
                    "zoom": 16,
                    "type": "yandex#map",
                    "traffic": {"shown": false}
                },
                "geoObjects": {
                    ...
                    "features": [{
                        ...
                        "id": "122927675",
                        "properties": {
                            "name": "Россия, Москва, 17-й проезд Марьиной Рощи, 9А",
                            "description": "",
                            "iconContent": "",
                            "iconCaption": "Medstyle.ru"
                        },
                        "geometry": {"type": "Point", "coordinates": [37.6081219999998, 55.808340840458996]},
                        "options": {"zIndex": 800000000, "order": 800000000, "preset": "islands#blueShoppingIcon"}
                    }]
                }
            }],
            "presetStorage": {}
        ...
        var o = {
            ...
            "size": ["100%", "100%"],
            "sid": "6d6c5e421e299aa67166dccef5f9f43c00ffa67fe482f99d400b37fd645b62a0",
            "elementId": "",
            "lang": "ru_RU",
        ...
        if (s && !window[a]) s.ready(o); else if (window[a]) window[a].queue.push(o); else {
            var u = "fid" + n.tid, c = n.isEnterprise ? t.enterpriseHost : t.host;
        ...
        function a(e) {
            ...
            var n = v + "-button", o = r.util.dom.styleSheet;
            o.addStyle("." + n, "{display: block; text-align:center;}"), o.addStyle("." + n + "-inner", "{ " + d + "} "), h = new r.control.Button({
                data: {content: ['<ymaps class="' + n + '">', '<ymaps class="' + v + " " + n + '-inner">', f, "</ymaps>", "</ymaps>"].join("")},
        ...
        function u(e) {
            function t(t) {
                var n = t.getElement().querySelector("." + v), r = e.container.getSize();
